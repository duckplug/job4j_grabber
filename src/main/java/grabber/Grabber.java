...
public class Grabber implements Grab {
    ...
    public static class GrabJob implements Job {
        ...
        public void execute(JobExecutionContext context) {
            ...
            try {
                posts = parse.
                        list("https://career.habr.com/vacancies?page=2&q=Java+developer&type=all");
            } catch (IOException e) {
    ...
    public void web(Properties config) {
        new Thread(() -> {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new Grabber(parse, store, scheduler, time).web(config);
